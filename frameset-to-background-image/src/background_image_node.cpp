...
void BackgroundImageNode::init()
{
	...
	//m_image_small_full_640_publisher 		= this->create_publisher<sensor_msgs::msg::Image>(out_small_ros_topic + "_full_640", m_qos_profile);
	m_image_small_full_640_kar_publisher	= this->create_publisher<sensor_msgs::msg::Image>(out_small_ros_topic + "_full_640_kar", m_qos_profile);
	...
	m_send_frame_small_full_640_bytes  	= reinterpret_cast<uint8_t 	*>(malloc(static_cast<unsigned>(640 * 640) * 3 * sizeof(uint8_t)));
...
void BackgroundImageNode::framesetCallback(camera_interfaces::msg::DepthFrameset::UniquePtr fset_msg)
{
	...
	if (m_send_frame_small_full_640_kar_bytes == NULL)
		m_send_frame_small_full_640_kar_bytes = reinterpret_cast<uint8_t *>(malloc(KAR_640_width * KAR_640_height * 3 * sizeof(uint8_t)));
	...
	//auto future_publishImage_full_640 		= std::async(&BackgroundImageNode::publishImage, this, m_send_frame_small_full_640_bytes, 640, 640, m_image_small_full_640_publisher);
	auto future_publishImage_full_640_kar	= std::async(&BackgroundImageNode::publishImage, this, m_send_frame_small_full_640_kar_bytes, KAR_640_width, KAR_640_height, m_image_small_full_640_kar_publisher);
	...
	//cv::Mat color_image_small_full_640;
	cv::Mat color_image_small_full_640_kar;
	...
	//cv::cuda::GpuMat color_image_cuda_small_full_640;
	cv::cuda::GpuMat color_image_cuda_small_full_640_kar;
	...
	//cv::cuda::resize(color_image_cuda, 		color_image_cuda_small_full_640, 		cv::Size(640,640));
	cv::cuda::resize(color_image_cuda, 		color_image_cuda_small_full_640_kar,	cv::Size(KAR_640_width,KAR_640_height), cv::INTER_AREA);
	...
	//color_image_cuda_small_full_640.download(color_image_small_full_640);
	color_image_cuda_small_full_640_kar.download(color_image_small_full_640_kar);
	...
	//future_publishImage_full_640.wait();
	...
	//std::memcpy(reinterpret_cast<void*>(m_send_frame_small_full_640_bytes), 	color_image_small_full_640.data, 		color_image_small_full_640.size().width * color_image_small_full_640.size().height * 3 * sizeof(uint8_t));
	std::memcpy(reinterpret_cast<void*>(m_send_frame_small_full_640_kar_bytes), color_image_small_full_640_kar.data, 	color_image_small_full_640_kar.size().width * color_image_small_full_640_kar.size().height * 3 * sizeof(uint8_t));
